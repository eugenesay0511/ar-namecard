    ...
    >
      ...
      >
        ...
        <a-entity id="robot-target" mindar-image-target="targetIndex: 0">
          ...
          <a-entity position="0 -0.8 0" scale="0.6 0.6 0.6">
            ...
            <a-entity
              position="0 3.2 0"
              scale="2 2 2"
              animation="property: position; to: 0 3.3 0; dir: alternate; dur: 2000; loop: true; easing: easeInOutSine"
            >
            ...
            <a-entity animation="property: position; to: 0 0.1 0; dir: alternate; dur: 2000; loop: true; easing: easeInOutSine">
              ...
              <a-entity position="-0.45 1.4 0">
                ...
                >
                  <a-sphere radius="0.1" color="#333"></a-sphere> {/* Elbow */}
                  <a-cylinder
                    position="0 0.35 0"
                    height="0.6"
                    radius="0.07"
